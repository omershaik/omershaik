...
- **[Axiom Research](https://github.com/omershaik/Axiom-Research)** · *Research / Agents* — Agentic AI research-report generator (docs, decks, PDFs); PRD-driven.
- **[Restauntpeer](https://github.com/omershaik/Restauntpeer)** · *Marketing / Automation* — End-to-end agentic pipeline: scrape → pick hero photo → sample brand palette → generate on-brand posts.
